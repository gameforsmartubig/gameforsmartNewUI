...
import { NavDesktop } from "@/app/(auth)/apps/mail/components/nav-desktop";
import { NavMobile } from "@/app/(auth)/apps/mail/components/nav-mobile";
import { MailDisplayMobile } from "@/app/(auth)/apps/mail/components/mail-display-mobile";
