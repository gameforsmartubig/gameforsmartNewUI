...
import { useStore, Table } from "@/app/(auth)/apps/pos-system/store";
import { EnumTableStatus, EnumTableStatusColor } from "@/app/(auth)/apps/pos-system/enums";

import { Badge } from "@/components/ui/badge";
import TableDetailDialog from "@/app/(auth)/apps/pos-system/tables/components/table-detail-dialog";
