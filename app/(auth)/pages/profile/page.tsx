...
import { CardSkills } from "@/app/(auth)/pages/profile/card-skills";
import { LatestActivity } from "@/app/(auth)/pages/profile/latest-activity";
import { AboutMe } from "@/app/(auth)/pages/profile/about-me";
import { Connections } from "@/app/(auth)/pages/profile/connections";
import { ProfileCard } from "@/app/(auth)/pages/profile/profile-card";
