...
interface AuthContextType {
  ...
  signUp: (email: string, password: string, username: string, fullname: string, countryId?: number | null, stateId?: number | null, cityId?: number | null, phone?: string | null) => Promise<void>
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  return <AuthContext.Provider value={{ user, profile, profileId, loading, refreshProfile, signIn, signUp, signOut }}>{children}</AuthContext.Provider>
}
